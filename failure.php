...
<head>
  ...
  function injectOrderId(){
  	window.addEventListener('load',function(){
       
        document.querySelector("#orderIdDiv").innerHTML="Your Order ID is  "+arguments[0];
       
        //$("#address_div").append("<strong>Appended item</strong>");
  });
  }
...
if(isset($_POST['orderid'])&&isset($_POST['method'])){
	global	 $connection;

	echo "<script>injectOrderId('".$_POST['orderid']."')</script>";
	...
	if($connection!=null){
       ...
       if($connection !=null){
       	...
       	$updatePaymentStatus="update `orders` SET payment_status='failed', payment_id='1221222'";
       	$result = mysqli_query($connection,$updatePaymentStatus);
                        if($result){
                          return true;
                        }else{
                          return false;
        ...
        <nav>
            <div class="nav-wrapper" style="background-color:#fff;">
                ...
                <ul class="right hide-on-med-and-down" style="padding-right: 5%;">
                    <li><a href="/routes" class="nav-override">Home</a></li>
                    ...
                    <li><a href="#" class="nav-override">Track Order</a></li>
                    <li><a href="#" class="nav-override">About</a></li>
...
<div id="failureContainer" >
	<div style="background-color:white ;margin: 5% 15%;box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.16), 1px 2px 1px 0px rgba(0, 0, 0, 0.12);"  >
				<div id="sorryContainer"  class="row" style="border-bottom: 1px solid #ccc;">
					<div style="margin:1vw 0 2vw 3vw;">
						
						<img src="images/Error.png" class="img-responsive" style="float:left;max-width:4vw;max-height:4vw"></img>
						
						<div style="font-size: 1.5vw;padding-top:1vw;color:#7A7A7A">Sorry - An Error occured during processing Your Order</div>
					
					</div>
				</div>

				<div id="orderIdContainer" class="row">
					<div style="padding: 1vw 3vw;margin: 1em 1em 4em;">
						<div>
								<div id="orderIdDiv" style="max-width:50%;border-bottom:1px dashed #ccc;padding-bottom: 1em;font-size:100% !important;font-weight: 600;margin-right:1em;"> Your Order ID is  jjjjjuuu</div>
									
						</div>	
						
					    <div style="margin-top:3vw	">
                            <a class="button js-checkout-button " style="float: left; " onclick="setGuestAddress()">Return to checkout page</a>
                        </div>
