...
<html>
<head>
<title>EatBliss||Internal server Error</title>
  <meta charset="utf-8">
  ...
  <script src="js/materialize.min.js"></script>
    ...
    history.pushState(null, null, 'error500.php');
...
<div id="failureContainer" style="background-image: url(images/bg.png);height:100%" >
 ...
 <div style="padding:10%">
        <span style="font-size:3vw;font-weight:600;margin-left:30%">OOPS ,Internal server Error(500)</span>
        <div style="font-size:2vw;font-weight:300;margin-left:25%"> There could be many reason For why you on this Page</div>
 </div>
<div>
